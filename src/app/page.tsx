...
export default function Home() {
  ...
  const sections: Section[] = [
    { 
      ...
      bgImage: '/webp_image/first.webp',
      stateImage: '/png_image/gentle_hi.png',
      bonusImage: '/png_image/speak/speak_hello.png',
      buttonLink: '/about',
    ...
    { 
      ...
      bgImage: '/webp_image/street_1.webp',
      stateImage: '/png_image/relax.png',
      bonusImage: '/png_image/speak/speak_nice.png',
      buttonLink: '/about',
      buttonText: 'Learn More'
    },
    { 
      ...
      bgImage: '/webp_image/sunset.webp',
      stateImage: '/png_image/should_be.png',
      buttonLink: '/public/portfolio',
    ...
    { 
      ...
      bgImage: '../webp_image/river_view.webp',
      stateImage: '../png_image/gentle_call.png',
